...
export default function ActivitiesPage() {
  return (
    <div className="flex flex-col items-center justify-center bg-white text-black dark:bg-zinc-900 dark:text-white">
      <p className="whitespace-nowrap text-[#F5AF28] text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-black mt-20">
        CÓ GÌ TẠI HỘI SÁCH?
      </p>
      <p className="whitespace-nowrap text-lg sm:text-xl md:text-3xl lg:text-4xl font-light py-10">
