  ...
  return (
    <div className="flex flex-col items-center">
      <section className="w-full overflow-hidden">
        <div className="relative w-full md:-mt-4 lg:-mt-8">
          <motion.div 
      ...
      <motion.section 
        className="w-full max-w-7xl px-4 pt-8 lg:pt-16 text-center relative z-10"
        initial="hidden"
        whileInView="visible"
      ...
      >
        <div className="p-12">
          <motion.h1 
            className="text-xl lg:text-3xl xl:text-4xl/snug mb-12 font-semibold"
      ...
      <section className="w-full bg-[#FEF9DB]">
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <motion.div 
              className="bg-white rounded-2xl shadow-md p-6 flex flex-col items-start relative transition-transform hover:scale-105"
            ...
            <motion.div 
              className="bg-white rounded-2xl shadow-md p-6 flex flex-col items-center justify-start transition-transform hover:scale-105"
              variants={cardVariants}
            >
